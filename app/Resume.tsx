      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-2">
                12年深耕数字视觉领域（建筑动画7年+数字展馆5年），精通三维可视化全流程管理。主导200+商业项目交付（含120+地产影片、30+政企展厅），服务万达、保利、金茂等TOP10房企及政府重点文化工程。
              </p>
              <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">
                技术实力：精通全流程数字视觉制作与技术方案落地，掌握3Dmax/AE/PR高级应用，专精异型幕影片制作与沉浸式体验设计。管理能力：带领20人团队跨部门高效协作，制定标准化SOP体系，项目交付准时率提升35%。
              </p>
            </div>
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-2">
              五折幕沉浸式影院项目，影片时长9分钟，全三维场景渲染，分辨率达12K。核心职责包括创意策划、三维镜头设计与制作、技术实现及团队管理。统筹12人团队协作，解决技术难题，确保高质量交付。
            </p>
            <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">
              项目成功落地并成为舟山城市展示馆的核心展项，获得参观者与馆方的一致好评。
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">
              瀑布屏沉浸式影片项目，时长4分30秒，分辨率4K，融合水墨风与三维实景。主导关键场景的三维镜头设计，监督跨朝代场景的无缝转场与瀑布屏适配。影片成为博博会热门展项，日均吸引超3000人次观看。
            </p>
          </div>
        </div>
