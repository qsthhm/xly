...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm transition-opacity">
      <div 
        ref={modalRef}
        className="bg-[#F0EFE7] dark:bg-[#202020] rounded-xl p-5 max-w-xs w-full shadow-xl transform transition-all"
      >
        ...
        <button
          onClick={copyPhone}
          className="flex items-center justify-center w-full py-2.5 px-4 mb-3 rounded-lg bg-[#C15F3C] text-white hover:bg-[#A94F32] transition-colors"
        >
        ...
        <button
          onClick={copyEmail}
          className="flex items-center justify-center w-full py-2.5 px-4 rounded-lg bg-[#C15F3C] text-white hover:bg-[#A94F32] transition-colors"
        >
