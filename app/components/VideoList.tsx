...
export default function VideoList({ 
  ...
  return (
    <div className="w-full flex flex-col">
      {/* 分类切换栏 */}
      <div className="sticky top-0 z-10 bg-card/95 backdrop-blur-sm px-2 py-3 border-b border-border flex space-x-2 overflow-x-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
        <button 
          ...
          >
            ...
            <div className="ml-3 flex-grow overflow-hidden">
              ...
              <div className="flex flex-col space-y-1">
                <p className="text-xs text-foreground/60 truncate">许璨雅</p>
